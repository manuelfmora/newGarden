        ...
        <div class="col-md-12">
            <div class="col-md-3 column">
               <ul class="nav nav-pills nav-stacked well">
                   <li class="active"><a href="?ctrl=listausuarios"><span class="glyphicon glyphicon glyphicon-list-alt"></span> Listar</a></li>
                   
                   <li><a href="?ctrl=altausuario" class="active2">&nbsp;&nbsp;<span class="glyphicon glyphicon glyphicon glyphicon-save"></span> Añadir</a></li>
